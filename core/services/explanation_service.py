...
def generate_explanation(
    ...
    if skills:
        ...
        explanation_parts.append(
            "The resume doesn't clearly highlight specific technical skills, which makes it challenging to assess technical proficiency against the role requirements."
        )
    ...
    score_context = (
        f"Our analysis generated a match score of {match_score:.2f} on a 0-1 scale, "
        "where higher scores indicate better alignment. This score considers multiple factors "
        "including skills, experience, and overall relevance."
    )
